...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      inputFormatters: widget.inputFormatter != null ? widget.inputFormatter : widget.inputType == TextInputType.phone ? <TextInputFormatter>[FilteringTextInputFormatter.allow(RegExp('[0-9+]'))] : null,
      decoration: widget.inputDecoration != null ? widget.inputDecoration : InputDecoration(
        ...
        hintStyle: widget.hintStyle != null ? widget.hintStyle : robotoRegular.copyWith(
