  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
                          ...
                          child: SafeArea(
                            child: Container(
                              ...
                              child: Column(children: [
                               ...
                               isOrderDetails ? Expanded(child: OrderScreen()) : CartDetails(
       ...
       if(showSetting) Positioned.fill(child: Align(alignment: Alignment.bottomCenter, child: Container(
          child: Padding(
