...
class Dimensions {
  static double fontSizeExtraSmall = Get.context!.width >= 1300 ? 14 : ResponsiveHelper.isSmallTab() ? 8 : 10;
  static double fontSizeSmall = Get.context!.width >= 1300 ?  16 : ResponsiveHelper.isSmallTab() ? 10 : 12;
  static double fontSizeDefault = Get.context!.width >= 1300 ?  18 :ResponsiveHelper.isSmallTab() ? 12 : 14;
  static double fontSizeLarge = Get.context!.width >= 1300 ? 20 : ResponsiveHelper.isSmallTab() ? 14 : 16;
  static double fontSizeExtraLarge = Get.context!.width >= 1300 ? 22 : ResponsiveHelper.isSmallTab() ? 16 : 18;
  static double fontSizeOverLarge = Get.context!.width >= 1300 ? 28 : ResponsiveHelper.isSmallTab() ? 20 : 24;
  ...
  static double paddingSizeExtraLarge = ResponsiveHelper.isSmallTab() ? 20 : 25.0;
